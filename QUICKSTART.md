...
The IETF 126 packet writes exact canonical bytes, the `action_digest`, selected fail-closed negative vectors, and signature-covered authorization-reference interop checks under `ietf126/results/`.
